...
def get_answer_token(seed, diff, config):
    ...
    print(f'diff: {diff}, time: {int((end - start) * 1e6) / 1e3}ms, solved: {solved}')
...
if __name__ == "__main__":
    ...
    cached_scripts.append(
        "https://cdn.oaistatic.com/_next/static/cXh69klOLzS0Gy2joLDRS/_ssgManifest.js?dpl=453ebaec0d44c2decab71692e1bfe39be35a24b3")
    cached_dpl = "dpl=453ebaec0d44c2decab71692e1bfe39be35a24b3"
    config = get_config("Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36")
    print(get_requirements_token(config))
